...
public class Programme_17_SortArrays {
    public static void main(String[] args) {
        ...
        String[] strArray = {"Bravo", "Delta", "Hotel", "Mike", "Sierra", "Peter", "Kilo"};
        System.out.println("Actual Numeric Array was :" + Arrays.toString(numArray));
        //Sorting the array
        Arrays.sort(numArray);
        System.out.println("Sorted Nummerical Array is : " + Arrays.toString(numArray));
        System.out.println("");
        System.out.println("Actual string array was :" + Arrays.toString(strArray));
        //Sorting the array
        Arrays.sort(strArray);
        System.out.println("Sortrd string Array is :"+Arrays.toString(strArray));
    }
}